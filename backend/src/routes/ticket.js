...
import { createTicket, deleteTicket, getTicket, getTickets, updateTicket } from "../controllers/ticket.js";
import {
...
router.route("/id/:ticketId").patch(updateTicketValidationChain, validationErrorHandling, updateTicket);
router.route("/id/:ticketId").post(deleteTicketValidationChain, validationErrorHandling, deleteTicket);
